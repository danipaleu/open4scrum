...
class open4scrum_mail{
	...
	function get_body(){
		...
		<meta property="og:title" content="<?php echo $this->subject; ?>" />
									...
									<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
										<tr>
											<td class="headerContent">
												...
												<img src="<?php echo get_stylesheet_directory_uri() ?>/img/logo.png" style="max-width:600px;" id="headerImage campaign-icon" />
													...
													<tr>
														<td colspan="2" valign="middle" id="social">
															<div mc:edit="std_social">
																&nbsp;<a href="http://open4scrum.com">open4scrum.com</a>&nbsp;
															</div>
														</td>
													</tr>
													<tr>
